    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10 px-4 print:p-0 print:bg-white text-black">
            ...
            <div className="relative w-full max-w-[1123px] aspect-[1.414/1] bg-white shadow-2xl flex flex-col print:shadow-none print:w-full print:border-none border-[20px] border-white ring-1 ring-gray-200 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col items-center justify-start text-center px-16 relative z-30 mt-[-40px]">
                    <div className="mb-1">
                        <span className="text-[#ca8a04] text-xs font-bold tracking-[0.4em] uppercase">Certificate of Completion</span>
                    </div>

                    <h1 className="text-[#1e3a8a] text-5xl font-serif font-bold tracking-widest mb-2">CERTIFICATE</h1>

                    <div className="w-24 h-1 bg-[#ca8a04] mb-4"></div>

                    <p className="text-gray-500 text-sm italic font-serif mb-2">This is to certify that</p>

                    <div className={`${pinyon.className} text-6xl text-[#1e3a8a] mb-4 min-h-[1.2em]`}>
                        {studentName}
                    </div>
                    ...
                    <h2 className="text-xl font-bold text-black border-b-2 border-gray-200 pb-1 mb-4 px-8 min-w-[400px]">
                        {courseName}
                    </h2>

                    <div className="max-w-2xl text-sm text-gray-600 mb-5 leading-relaxed">
